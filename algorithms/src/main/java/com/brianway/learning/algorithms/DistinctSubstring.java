package com.brianway.learning.algorithms;
...
public class DistinctSubstring {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(d.longestSubstring("aabcba", 6));
//        System.out.println(d.longestSubstring("bacdbad",7));
